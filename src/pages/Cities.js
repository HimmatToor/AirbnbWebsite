        ...
        <div className="cities-container">
            ...
            <div className="city-grid">
                ...
                <div className="city-card" onClick={() => navigate("/city/dallas")}>
                    <img src="/assets/DAL.png" alt="Dallas" className="city-img" />
                    <h3>Dallas</h3>
                </div>

                <div className="city-card" onClick={() => navigate("/city/denver")}>
                    <img src="/assets/DEN.png" alt="Denver" className="city-img" />
                    <h3>Denver</h3>
                </div>

                <div className="city-card" onClick={() => navigate("/city/chicago")}>
                    <img src="/assets/CHI.png" alt="Chicago" className="city-img" />
                    <h3>Chicago</h3>
                </div>

                <div className="city-card" onClick={() => navigate("/city/la")}>
                    <img src="/assets/LA.png" alt="Los Angeles" className="city-img" />
                    <h3>Los Angeles</h3>
                </div>
            </div>
